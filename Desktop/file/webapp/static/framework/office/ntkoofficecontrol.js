...
var width="100%";
//买断授权密钥如果不是买断可以不用写
var MakerCaption="烟台海颐软件股份有限公司"; 
//买断授权密钥如果不是买断可以不用写
var MakerKey="8F0098042AB22C5C118CE240658486634E5EF887";
//密钥
var ProductCaption="欢迎使用！";
//密钥
var ProductKey="1EF286E39381110FB86A99E4EA37AADFBE26BAB7";
...
window.onbeforeunload=function(){
 var ntkoquery= ntkoBrowser.ntkoGetQueryString("ntkoieword");

if(ntkoquery=="ntkoieword"){
	alert("ie浏览器");
}
else{
    window.opener =null;
...
var ntkoBrowser={
		...
		//判断是否用ie进行打开
        ntkoGetQueryString:function(name){

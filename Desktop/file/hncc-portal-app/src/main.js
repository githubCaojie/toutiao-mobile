...
import {
  ...
  Skeleton, Search, Card, Badge ,Lazyload ,
} from 'vant';
...
Vue.use(Button).use(Field).use(Cell).use(CellGroup).use(Loading).use(Overlay).use(NavBar).use(Toast)
  ...
  .use(Progress).use(Grid).use(GridItem).use(RadioGroup).use(Radio).use(Skeleton).use(Search).use(Card).use(Badge).use(Lazyload);

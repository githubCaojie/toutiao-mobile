      ...
      <app-list ref="xcbyList" :immediate="false">
        <template v-slot="{ data }">
          <div class="app-list" @click="goDetail(data)">
            ...
            <p class="app-list-item">
              问题类型1：<app-drop-show :dpData="troubleTypeList" :value="data.troubleType"></app-drop-show>
            </p>
            <p class="app-list-item">
  ...
  methods: {
    ...
    delItem(data) {
      this.appCommon.confirm("提示", "确定要删除该记录吗？", () => {
        ...
        postAction("/leadTroubleDeal/appCancel", params).then((rdata) => {
          this.$toast("删除成功~");
          this.query();
        });
      });
    ...
    dataList(pageInfo) {
      ...
      return new Promise((resolve, reject) => {
        this.appCommon.postReq("/leadTroubleDeal/list", params).then((rdata) => {
